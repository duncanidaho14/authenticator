...
const NavbarTop = (props) => {
       return(
              <div>
                         <div x-data="setup()" x-init="$refs.loading.classNameList.add('hidden');" classNameName="{ 'dark': isDark}">

                            <div className="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
        <div
          x-ref="loading"
          className="fixed inset-0 z-50 flex items-center justify-center text-2xl font-semibold text-white bg-opacity-90 bg-blue-800"
        >
                                   Loading.....
        </div>
            ...
            <nav aria-label="Main" className="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
              <div x-data="{ isActive: false, open: false}">
                ...
                <a
                  ...
                  classNameName="{'bg-blue-100 dark:bg-blue-600': isActive || open}"
                  role="button"
                  aria-haspopup="true"
          ...
          <header className="relative bg-white dark:bg-darker">
            <div className="flex items-center justify-between p-2 border-b dark:border-blue-800">
              ...
              <button
                ...
                className="p-1 text-blue-400 transition-colors duration-200 rounded-md bg-blue-50 hover:text-blue-600 hover:bg-blue-100 dark:hover:text-light dark:hover:bg-blue-700 dark:bg-dark md:hidden focus:outline-none focus:ring"
              >
                <span className="sr-only">Open sub mann</span>
                <span aria-hidden="true">
                  <svg
                    className="w-8 h-8"
                    xmlns="http://www.w3.org/2000/svg"
...
aria - label="User menu"
       ...
       <div x-data="{ isActive: false, open: false }">
              <!-- active classNamees 'bg-blue-100 dark:bg-blue-600' -->
                  <a
                     href="#"
                    @click="$event.preventDefault(); open = !open"
                    className="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-blue-100 dark:hover:bg-blue-600"
