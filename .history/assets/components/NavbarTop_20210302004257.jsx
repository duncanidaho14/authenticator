...
const NavbarTop = props => {
       ...
       return (
              ...
              <div>
                    <div x-data="setup()" x-init="$refs.loading.classNameList.add('hidden');" :class="{ 'dark': isDark}">
                     <div className="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
                            ...
                            <aside className="flex-shrink-0 hidden w-64 bg-white border-r dark:border-blue-800 dark:bg-darker md:block">
                                   ...
                                   <nav aria-label="Main" className="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
                                          ...
                                          <a href="#" @click="$event.preventDefault(); open = !open" className="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-blue-100 dark:hover:bg-blue-600"
                                                 :class="{'bg-blue-100 dark:bg-blue-600': isActive || open}" role="button" aria-haspopup="true" :aria-expanded="(open || isActive) ? 'true' : 'false'"
                                          >
              ...
              <div x-data="{ isActive: false, open: false }">
                <a
                  ...
                  :className="{ 'bg-blue-100 dark:bg-blue-600': isActive || open }"
                  role="button"
                  aria-haspopup="true"
       ...
       <div x-data="{ isActive: false, open: false}">
              ...
              <span aria-hidden="true" className="ml-auto">
                     <svg classNameName="w-4 h-4 transition-transform transform"
                      : {'rotate-180': open }"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
            ...
            <div className="flex items-center justify-between p-2 border-b dark:border-blue-800">
              ...
              <nav aria-label="Secondary" className="hidden space-x-2 md:flex md:items-center">
                <button aria-hidden="true" className="relative focus:outline-none" x-cloak @click="toggleTheme">
                  <div
                    className="w-12 h-6 transition bg-blue-100 rounded-full outline-none dark:bg-blue-400"
                  ></div>
                  <div
                    ...
                    :className="{ 'translate-x-0 -translate-y-px  bg-white text-blue-700': !isDark, 'translate-x-6 text-blue-100 bg-blue-800': isDark }"
                  >
                    <svg
                      x-show="!isDark"
                      className="w-4 h-4"
       ...
       <div className="space-x-2">
              ...
              <div
                     className="absolute top-0 left-0 inline-flex items-center justify-center w-6 h-6 transition-all duration-200 transform scale-110 rounded-full shadow-sm"
                      : {'translate-x-0 -translate-y-px  bg-white text-blue-700': !isDark, 'translate-x-6 text-blue-100 bg-blue-800': isDark }"
                    >
                      <svg
                     x-show="!isDark"
                     className="w-4 h-4"
...
aria - label="User menu"
       ...
       >
              <nav aria-label="Main" className="px-2 py-4 space-y-2">
                <!-- Dashboards links -->
                <div x-data="{ isActive: false, open: false}">
                  <!-- active & hover classNamees 'bg-blue-100 dark:bg-blue-600' -->
                  <a
                    href="#"
                    @click="$event.preventDefault(); open = !open"
                    className="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-blue-100 dark:hover:bg-blue-600"
